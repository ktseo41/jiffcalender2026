...
const OUTPUT_PATH = path.join(ROOT_DIR, 'jiff2026', 'schedule-meta.js');
...
async function main() {
  ...
  fs.writeFileSync(
    OUTPUT_PATH,
    [
      '// Generated by scripts/sync-jiff-schedule-meta.js',
      `window.JIFF_SCHEDULE_META = Object.freeze(${JSON.stringify(payload, null, 2)});`,
      '',
    ].join('\n'),
    'utf8'
  );
